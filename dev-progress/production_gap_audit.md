...
- Maven now runs 99 Java tests covering AuthService, JwtAuthenticationFilter preflight behavior, DatasourceAdminService, DatasourceAdminController, AnalyticsController, AccountAdminController, AuditLogController, CustomerController, FollowupController, NoticeController, QuickSearchAdminController, SkillAdminController, AiConfigController, TagAdminController, DesktopVersionController, and DesktopVersionRepository.
