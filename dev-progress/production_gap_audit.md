...
- Maven now runs 60 Java tests covering AuthService, JwtAuthenticationFilter preflight behavior, DatasourceAdminService, AccountAdminController, AuditLogController, NoticeController, QuickSearchAdminController, SkillAdminController, DesktopVersionController, and DesktopVersionRepository.
