...
public class SupervisionMetricsRepository {
  ...
  public Counts aiCoverage(SupervisionMetricsQuery query) {
    return new Counts(
        countCandidateCustomersInBaseline(
            query, List.of("REPLY_GENERATED", "REPLY_COPIED"), List.of("RECOGNITION_PROCESSED")),
        countDistinctEventCustomers(query, List.of("RECOGNITION_PROCESSED")));
  }
  ...
  public Counts processingEfficiency(SupervisionMetricsQuery query, int slaMinutes) {
    ...
    long denominator = countDistinctEventCustomers(query, List.of("RECOGNITION_PROCESSED"));
    ...
    String sql = """
        ...
        WHERE pending.event_type = 'RECOGNITION_PROCESSED'
  ...
  public Counts aiReplyConversion(
